...
public class PersonalResultDetailActivity extends AppCompatActivity
    ...
    public void onLoadFinished(Loader<String> loader, String data) {
        ...
        if (data != null) {
            ...
            rv_personal_search_results.setVisibility(View.VISIBLE);
            ArrayList<FOAASUtils.SearchResult> searchResultsList = FOAASUtils.parseFOAASResultsJSON(data);
            mFOAASPersonalSearchAdapter.updateSearchResults(searchResultsList);
        } else {
            rv_personal_search_results.setVisibility(View.INVISIBLE);
