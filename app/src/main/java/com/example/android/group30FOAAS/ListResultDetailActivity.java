...
public class ListResultDetailActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv_list_search_results = (RecyclerView)findViewById(R.id.rv_search_results);
        mSubtitleTV = (TextView)findViewById(R.id.tv_subtitle);

        mFOAASListSearchAdapter = new FOAASListSearchAdapter((FOAASListSearchAdapter.OnSearchResultClickListener) this);
